...
public class EmailServiceImplementation implements EmailService {
    ...
    public void sendRegistrationEmail(String to, String name,String link) {
        try{
            ...
            helper.setText(buildRegistrationEmail(name,link), true);
            helper.setTo(to);
    ...
    public void sendPasswordResetEmail(String to, String name, String code) {
        try {
            ...
            helper.setText(buildPasswordResetEmail(name,code), true);
            helper.setTo(to);
    ...
    public String buildPasswordResetEmail(String name, String code) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p>" +
                            "<p style=\"margin: 0 0 20px 0; font-size: 19px; line-height: 25px; color: #0b0c0c;\">We know that you are trying to reset your password. Your password reset code is: <strong>\""+code+"\"</strong></p>\n" +
                            "<p style=\"margin: 0 0 20px 0; font-size: 19px; line-height: 25px; color: #0b0c0c;\">This code will expire in 15 minutes.</p>\n" +
                            "<p>See you soon</p>\n" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
